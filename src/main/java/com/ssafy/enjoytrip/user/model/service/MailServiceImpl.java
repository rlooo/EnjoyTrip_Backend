...
//		System.out.println("인증 번호 : " + ePw);
		...
		message.setSubject("EnjoyTrip 비밀번호 찾기 이메일 인증");// 제목
		
		String msgg = "";
		msgg += "<div style='margin:100px;'>";
		msgg += "<h1> 안녕하세요</h1>";
		msgg += "<h1> 여행 정보 사이트 EnjoyTrip 입니다.</h1>";
		msgg += "<br>";
		...
		message.setFrom(new InternetAddress("ssafy1010@naver.com", "EnjoyTrip"));// 보내는 사람
	...
	public String sendSimpleMessage(String to) throws Exception {
		...
		System.out.println(Arrays.toString(to.toCharArray()));
		ePw = createKey(); // 랜덤 인증번호 생성
		
		// TODO Auto-generated method stub
				MimeMessage message = createMessage(to.trim().replaceAll("\"", "")); // 메일 발송
				try {// 예외처리
